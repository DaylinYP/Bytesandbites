...
<div class="contenedor">
    <section class="encabezadoBienvenidos" style="margin-top: 20%;">
        ...
        <p class="pBienvenidos">Si no tienes una cuenta con nosotros, <br> por favor llena los campos con tus datos para
            crear una cuenta.</p>
    </section>
    ...
    <section class="formulario1">
        <article>
            ...
            <form method="POST" action="<?php echo base_url('registro') ?>" autocomplete="off">
                ...
                <div>
                    <a href="<?= base_url('nombre_de_inicio_de_sesion'); ?>">Iniciar Sesión</a>
                </div>
            </form>
